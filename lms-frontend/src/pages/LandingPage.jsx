...
const LandingPage = () => {
  ...
  useEffect(() => {
    const fetchTopFive = async () => {
      try {
        const response = await axios.get('http://localhost:5000/api/public/top-five');
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-between">
      ...
      {/* Hero Section with Leaderboard next to it */}
      <section className="px-6 py-20 bg-gradient-to-b from-white to-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left flex flex-col items-center lg:items-start">
            <span className="inline-block text-xs font-semibold text-brand-600 bg-brand-50 px-3 py-1.5 rounded-full uppercase tracking-wider">
            ...
            <p className="text-slate-500 text-base md:text-lg mt-6 leading-relaxed max-w-2xl">
          ...
          <div className="lg:col-span-5 w-full">
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xl flex flex-col justify-between">
              <div className="text-center mb-6">
                ...
                <p className="text-xs text-slate-400 mt-2">Click a student name to view their full profile</p>
              </div>
              ...
              <div className="space-y-3">
                {topRankings.map((student) => (
                  <button
                    key={student.rank}
                    onClick={() => {
                      if (student.studentId) navigate(`/profile/${student.studentId}`);
                    }}
                    className="w-full flex items-center justify-between p-3 border rounded-xl transition-all text-left border-slate-100 hover:border-brand-300 bg-slate-50/50 hover:bg-brand-50 hover:shadow-sm"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2">
                        {student.profilePicture ? (
                          <img src={student.profilePicture} alt="" className="w-8 h-8 rounded-full object-cover shrink-0" />
                        ) : (
                        ...
                        <div>
                          <p className="font-semibold text-xs leading-none text-slate-800 hover:text-brand-700">{student.name}</p>
                          <span className="inline-block text-[9px] bg-brand-50/80 text-brand-600 px-1.5 py-0.5 rounded font-medium mt-1">
                            {student.badge}
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="text-right shrink-0">
                      <p className="text-xs font-bold text-slate-800">{student.totalScore} pts</p>
                      <p className="text-[9px] text-slate-400 mt-0.5">{student.assessmentsCompleted} assessments</p>
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="mt-6 text-center">
                <Button size="sm" variant="outline" className="gap-2 w-full justify-center" onClick={() => navigate('/leaderboard')}>
